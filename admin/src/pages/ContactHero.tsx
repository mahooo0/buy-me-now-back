...
export default function ContactHero() {
    ...
    const { data: ContactHero } = GETRequest<any>(
        'contact-hero',
        '/contact-hero',
        []
    );
    console.log('ContactHero', ContactHero);
    ...
    const handleSubmit = (values: Record<string, any>) => {
        ...
        ForumData.append('image', newValues.image);
        ...
        <div>
            {isForumOpen ? (
                <Forum
                    ...
                    initialvalues={
                        id === 0 ? {} : reverseTransformObject(ContactHero[0])
                    }
