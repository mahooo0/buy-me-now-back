...
const Create = async (req, res) => {
    try {
        ...
        const newSeo = new Schema({ title, description, video });
        newSeo.save();
...
const ReadHomeProductBunner = async (req, res) => {
    try {
        const HeroArrey = await Schema.find({});
...
module.exports = { Read, Create, Edit, ReadHomeProductBunner };
